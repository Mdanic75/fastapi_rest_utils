import pytest
from fastapi_rest_utils.viewsets.base import ListView, RetrieveView, CreateView, UpdateView, PartialUpdateView, DeleteView
from conftest import TestProductSchema, TestProductCreateSchema, TestProductUpdateSchema
...
class ModelViewSet(MyListView, MyRetrieveView, MyCreateView, MyUpdateView, MyDeleteView):
    schema_config = {
