...
def db_dep_injector(session_dependency: Callable[[Request], Any]) -> Callable[[Request], Any]:
    """
    ...
    """
    async def set_db_on_request(request: Request, db: Any = Depends(session_dependency)) -> None:
        request.state.db = db
    return set_db_on_request


def auth_dep_injector(user_dependency: Callable[[Request], Any]) -> Callable[[Request], Any]:
    """
    ...
    """
    async def set_user_on_request(request: Request, user: Any = Depends(user_dependency)) -> Any:
