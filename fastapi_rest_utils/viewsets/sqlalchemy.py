...
class SQLAlchemyPartialUpdateView(PartialUpdateView):
    model: Any
...
class ModelViewSet(SQLAlchemyBaseViewSet, ListView, RetrieveView, CreateView, UpdateView, PartialUpdateView, DeleteView):
    """
